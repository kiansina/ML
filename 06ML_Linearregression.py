...
## 2
########### Ridge
# Ridge: it is similar to least squares. It just has an extra penalty term.
...
# POINT: amount of regularization is controlled by alpha parameter. Larger alpha parameter => More regularization wish simpler linear models with weights closer to 0
...
## 3
###### Lasso regression
# With Lasso regression a subset of the coefficients ARE FORCED to be precisely 0. Since with the weight of 0 the features are essentially ignored completely in the model (Continue below line)
